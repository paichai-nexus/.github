...
```text
       ...
       ┌────────────┬───────────┬───────────┬────────────┐
       │            │           │           │            │
    기획전략부   프로젝트운영부  연구개발부  디자인·커뮤니케이션부
       │            │           │           │
       ├────────────┼───────────┼───────────┤
       │            │           │           │
    대외협력부    경영지원부    교육·행사부   인문사회·사용자연구부
```
...
| --- | --- |
| 🧭 **기획전략부** | 신규 의제 발굴, 프로젝트 구조화, 로드맵·우선순위 |
| 📋 **프로젝트운영부** | 일정, 업무분장, 회의·진척 관리, 산출물 관리 |
| 🧑‍💻 **연구개발부** | SW·AI·HW·데이터·기술 구현 및 연구 |
| 🎨 **디자인·커뮤니케이션부** | UX/UI, 시각화, 브랜드·발표·콘텐츠 |
| 🤝 **대외협력부** | 교수·기업·기관·타대학 협력 및 외부 커뮤니케이션 |
| 💼 **경영지원부** | 예산·행정·사업화·운영지원 |
| 🎓 **교육·행사부** | 세미나·스터디·부스·행사 운영 |
| 🔎 **인문사회·사용자연구부** | 사용자 조사, 정책·법·사회적 타당성, Human Review |
